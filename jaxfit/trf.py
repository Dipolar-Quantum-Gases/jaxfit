...
class TrustRegionJITFunctions():
    ...
    def create_svd_funcs(self):
        ...
        @jit
        def svd_bounds(f, J, d, J_diag, f_zeros):
            J_h = J * d
...
class TrustRegionReflective(TrustRegionJITFunctions):
    ...
    def trf(self, fun, xdata, ydata, jac, data_mask, transform, x0, f0, J0,
            lb, ub, ftol, xtol, gtol, max_nfev, f_scale, x_scale, 
            loss_function, tr_options, verbose, timeit=False):
    ...
    def trf_no_bounds(self, fun, xdata, ydata, jac, data_mask, transform, x0, 
    ...
    def trf_bounds(self, fun, xdata, ydata, jac, data_mask, transform, x0, 
                    f, J, lb, ub, ftol, xtol, gtol, max_nfev, f_scale, x_scale, 
                    loss_function, tr_options, verbose):
    ...
    def trf_no_bounds_timed(self, fun, xdata, ydata, jac, data_mask, transform, x0, 
            f0, J0, lb, ub, ftol, xtol, gtol, max_nfev, f_scale, x_scale, 
            loss_function, tr_options, verbose):
